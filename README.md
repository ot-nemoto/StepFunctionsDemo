...
This is a sample template for StepFunctionsDemo - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name stepfunctionsdemo --tail
```
...
```bash
aws cloudformation delete-stack --stack-name stepfunctionsdemo
```
